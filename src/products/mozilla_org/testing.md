...
* Adding the l10n project manager in charge for Need Info. You can find the [project manager](../l10n_project_managers.md) for any project hosted in Pontoon directly in the [header of the project page](../tools/pontoon/teams_projects.md#project-page).
