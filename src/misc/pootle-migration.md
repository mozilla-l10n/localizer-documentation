...
Unlike Pootle, there’s no difference between the ability to review suggestions and submit translations. [This document](https://pontoon.mozilla.org/docs/localizer/users/) describes user roles in Pontoon with more details.
